...
如下圖，$\Delta ABC$ 中，$D$、$E$、$F$ 分別是 $\overline{BC}$、$\overline{AC}$ 與 $\overline{AB}$ 上的點，使得 $\overline{AD}$、$\overline{BE}$ 與 $\overline{CF}$ 交於一點 $P$，且將 $\Delta ABC$ 分割成 6 個小三角形，其中 4 個三角形 $\Delta CDP$、$\Delta BDP$、$\Delta BFP$、$\Delta AEP$ 的面積分別是 $30$、$40$、$56$、$70$，試求 $\Delta ABC$ 的面積。 (114校內學科競賽)
